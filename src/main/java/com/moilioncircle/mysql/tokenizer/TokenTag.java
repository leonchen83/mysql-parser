...
public enum TokenTag {
    HEX_VALUE("HEX_VALUE", TokenType.DEFAULT), BIT_VALUE("BIT_VALUE", TokenType.DEFAULT), IDENT("IDENT", TokenType.DEFAULT), STRING("STRING", TokenType.DEFAULT), TRUE("TRUE", KEYWORDS), FALSE("FALSE", KEYWORDS), NULL("NULL", KEYWORDS), NUMBER("NUMBER", TokenType.DEFAULT),
    ...
    ENGINE("ENGINE",KEYWORDS),AUTO_INCREMENT("AUTO_INCREMENT",KEYWORDS),AVG_ROW_LENGTH("AVG_ROW_LENGTH",KEYWORDS),
    CHECKSUM("CHECKSUM",KEYWORDS),CONNECTION("CONNECTION",KEYWORDS),DATA("DATA",KEYWORDS),DIRECTORY("DIRECTORY",KEYWORDS),
    ...
    DYNAMIC("DYNAMIC",KEYWORDS),FIXED("FIXED",KEYWORDS),COMPRESSED("COMPRESSED",KEYWORDS),REDUNDANT("REDUNDANT",KEYWORDS),
    ...
    STORAGE("STORAGE",KEYWORDS),DISK("DISK",KEYWORDS),MEMORY("MEMORY",KEYWORDS),UNION("UNION",KEYWORDS),
    LAST("LAST",KEYWORDS),LINEAR("LINEAR", KEYWORDS),RANGE("RANGE",KEYWORDS),COLUMNS("COLUMNS",KEYWORDS),
    LIST("LIST",KEYWORDS),PARTITIONS("PARTITIONS",KEYWORDS),SUBPARTITION("SUBPARTITION",KEYWORDS),
    SUBPARTITIONS("SUBPARTITIONS",KEYWORDS),VALUES("VALUES",KEYWORDS),LESS("LESS",KEYWORDS),THAN("THAN",KEYWORDS),
    MAXVALUE("MAXVALUE",KEYWORDS),IN("IN",KEYWORDS),NODEGROUP("NODEGROUP",KEYWORDS),REFERENCES("REFERENCES",KEYWORDS),
    MATCH("MATCH",KEYWORDS),FULL("FULL",KEYWORDS),PARTIAL("PARTIAL",KEYWORDS),SIMPLE("SIMPLE",KEYWORDS),
    ON("ON",KEYWORDS),DELETE("DELETE",KEYWORDS),UPDATE("UPDATE",KEYWORDS),ACTION("ACTION",KEYWORDS),NOT("NOT",KEYWORDS),
    COLUMN_FORMAT("COLUMN_FORMAT",KEYWORDS),BIT("BIT",KEYWORDS),TINYINT("TINYINT",KEYWORDS),UNSIGNED("UNSIGNED",KEYWORDS),
    ZEROFILL("ZEROFILL",KEYWORDS),SMALLINT("SMALLINT",KEYWORDS),MEDIUMINT("MEDIUMINT",KEYWORDS),INT("INT",KEYWORDS),
    INTEGER("INTEGER",KEYWORDS),BIGINT("BIGINT",KEYWORDS),REAL("REAL",KEYWORDS),DOUBLE("DOUBLE",KEYWORDS),FLOAT("FLOAT",KEYWORDS),
    NUMERIC("NUMERIC",KEYWORDS),DATE("DATE",KEYWORDS),TIME("TIME",KEYWORDS),TIMESTAMP("TIMESTAMP",KEYWORDS),DATETIME("DATETIME",KEYWORDS),
    YEAR("YEAR",KEYWORDS),CHAR("CHAR",KEYWORDS),BINARY("BINARY",KEYWORDS),VARCHAR("VARCHAR",KEYWORDS),VARBINARY("VARBINARY",KEYWORDS),
    TINYBLOB("TINYBLOB",KEYWORDS),BLOB("BLOB",KEYWORDS),MEDIUMBLOB("MEDIUMBLOB",KEYWORDS),LONGBLOB("LONGBLOB",KEYWORDS),
    TINYTEXT("TINYTEXT",KEYWORDS),TEXT("TEXT",KEYWORDS),MEDIUMTEXT("MEDIUMTEXT",KEYWORDS),LONGTEXT("LONGTEXT",KEYWORDS),
    ENUM("ENUM",KEYWORDS),DECIMAL("DECIMAL",KEYWORDS),CREATE("CREATE",KEYWORDS),
    LIKE("LIKE",KEYWORDS),REPLACE("REPLACE",KEYWORDS),SELECT("SELECT",KEYWORDS),
    CURRENT_TIMESTAMP("CURRENT_TIMESTAMP",KEYWORDS),LOCALTIMESTAMP("LOCALTIMESTAMP",KEYWORDS),
    NOW("NOW",KEYWORDS),LOCALTIME("LOCALTIME",KEYWORDS),CURRENT_DATE("CURRENT_DATE",KEYWORDS),CHARSET("CHARSET",KEYWORDS);
